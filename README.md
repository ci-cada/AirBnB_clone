...
| --- | --------- | ----------- | -----| ----- | -----| ------- | ----- | ------ |
| *Public Instance Attribute* | `id`<br>`created_at`<br>`updated_at` | | Inherits from `BaseModel` | Inherits from `BaseModel` | Inherits from `BaseModel` | Inherits from `BaseModel` | Inherits from `BaseModel` | Inherits from `BaseModel` |
| *Public Instance Method* | `save`<br>`to_dict` | `all`<br>`new`<br>`save`<br>`reload` | Inherits from `BaseModel` | Inherits from `BaseModel` | Inherits from `BaseModel` | Inherits from `BaseModel` | Inherits from `BaseModel` | Inherits from `BaseModel` |
...
This creates a new isntance of a given class. The class" ID is printed and the instance is saved to the file `file.json`
...
This prints the string representation of a class instance based on a given id.
...
This deletes a class instance based on a given id. The storage file `file.json` is updated accordingly
...
This updates a class instance based in a given id with a given key/value attribute pain or dictionary ot attribute pairs. If `update` is called with a single key/value attribute pair, only "simple" attributes can be updated (i.e. not `id` , `created_at` and `updated_at`).

However any attribute can be updated by providing a dictionary.
...
This retrieves a number of instances of a given class.
...
This prints the string representations of all instances of a given class. If no class name is provided, the command prints all instances of every class.
